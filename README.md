        ...
        <div className="photo-side">
          <div className="photo-frame">
            ...
            <div className="founder-img">
              <img src={founderImg} alt="Kodiya Nekara — Founder of Voltix Pro GH" />
            </div>
            <div className="photo-badge">⚡ Kodiya Nekara — Founder</div>
          </div>

          <div className="trust-badge" style={{ marginTop: 36 }}>
            <div className="trust-dot"></div>
            Open & Ready to Deliver Across Ghana 🇬🇭
          </div>
        </div>

        <div className="text-side">
          <div className="welcome-tag">👋 Welcome to Voltix Pro GH</div>

          <h1 className="welcome-heading">
            Ghana's #1<br />
            <span className="highlight">Premium Earpods</span><br />
            Store
          </h1>

          <div className="founder-name">
            By <span>Kodiya Nekara</span> · Trust God Company
          </div>

          <p className="welcome-intro">
            Hi! I'm Kodiya, founder of Voltix Pro GH. I created this store to give every
            Ghanaian access to premium wireless earpods at prices that make sense. No
            overpricing — just real quality, real value, delivered to your door. 🎧
          </p>

          <div className="offerings">
            {[
              ['🎧', 'Premium Earpods', 'From Ghc 40 — quality for every budget'],
              ['🔊', 'Hi-Res Sound', 'Noise cancelling & crystal clear audio'],
              ['📱', 'MoMo Payment', 'MTN, Telecel, Airtel, Card & Cash'],
              ['🚚', 'Fast Delivery', 'Delivered across all of Ghana'],
              ['✅', '100% Genuine', 'Authentic products guaranteed'],
              ['🔁', 'Easy Returns', '7-day return if defective'],
            ].map(([icon, title, desc]) => (
          ...
          <div className="cta-row">
            <a href="#products" className="cta-main">🛒 Shop Now →</a>
            <a href="https://wa.me/233536193862" target="_blank" rel="noreferrer" className="cta-wa">
              📱 Chat With Me
            </a>
          </div>
          ...
          <div className="stats-row">
            ...
            <div className="stat">
              <div className="stat-num">Ghc40</div>
              <div className="stat-label">Starting From</div>
            </div>
            <div className="stat">
              <div className="stat-num">48h</div>
              <div className="stat-label">Max Battery</div>
            </div>
            <div className="stat">
              <div className="stat-num">🇬🇭</div>
              <div className="stat-label">Made for Ghana</div>
            </div>
          </div>
        </div>
      </div>
